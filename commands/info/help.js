...
module.exports = {
  ...
  aliases: ['cmmds'],
  usage: '[command]',
  description: "Sends a menu with various commands option!",
  category: "info",
  cooldown: 0,
  userPermissions: "",
  botPermissions: "",
...
> You can also mention ${client.user} to get prefix info.`)
          .addFields([{
            name: `<:M_Category:947035084224102440>**Categories:**`,
            value: `>>> **<a:TICK:900616572807299102> [*Overview*](${process.env.WEBSITE})
🔰 [*Information*](${process.env.WEBSITE})
🎶 [*Music*](${process.env.WEBSITE})
💪 [*Setup*](${process.env.WEBSITE})
<:moderator:946966417947885658> [*Moderation*](${process.env.WEBSITE})
🕹️ [*Fun*](${process.env.WEBSITE})
<a:m_:934118917801136208> [*Mini Games*](${process.env.WEBSITE})
<a:giveaway58:927396907129643099> [*Giveaway*](${process.env.WEBSITE})
🎟 [*Ticket*](${process.env.WEBSITE})
🔨 [*Utility*](${process.env.WEBSITE})
📄 [*Report*](${process.env.WEBSITE})
<a:d_:900617356907249674> [*Ranking*](${process.env.WEBSITE})**`
          }])
